...
//     "mainDomain": "laifeng.com",
//     "subDomain": "",
//     "prefix": "acs",
//     "liveAppkey": 24679788,
//     "pageDomain": "laifeng.com",
//     "getJSON": true,
//     "token": "382e6816eaaa3411966a4fdd98e493c3" //需要逆向
// }
...
// function o(t) {
//     var e = new RegExp("(^| )".concat(t, "=([^;]*)(;|$)"),"gi").exec(unescape(documentCookie));
//     return e ? e[2] : null
// }
// token= decodeURIComponent(Object(o('imk')) || "")



// 获取sign
//暂时token没有逆向
function getSign(paramData,documentCookie){
    // var documentCookie=documentCookie
    // 从cookie里提取token
    function k(a) {
        var b = new RegExp("(?:^|;\\s*)" + a + "\\=([^;]+)(?:;\\s*|$)").exec(documentCookie);
        return b ? b[1] : void 0
    }
    function getToken(){
        let A='_m_h5_c'
        ...
        return a.CDR && k(A) ? a.token = k(A,documentCookie).split(";")[0] : a.token = a.token || k(B),a.token && (a.token = a.token.split("_")[0])
     }
    
    //// 获取token
    let g_1=24679788 // appid
    let i_1=(new Date).getTime()
    // console.log(i_1)
    paramData=paramData
    // console.log(c_1)
    token=getToken()
    // token="9b2cb87e6279789975e25bb50fd34b6e"
    j = h(token + "&" + i_1 + "&" + g_1 + "&" + paramData)
